...
readonly class DefaultDataGridEntityFactory
{
    ...
    public function create():DataGridEntity
    {
        ...
        $dataGridEntity
            ...
            ->addColumn((new BooleanColumnEntity('is_default', $this->translator->translate('column_is_default')))
            ...
            ->addColumn((new BooleanColumnEntity('active', $this->translator->translate('column_is_active')))
                ->setOnClickCallback(function(int $id):void{
                    $language = $this->languageModel->get($id);
