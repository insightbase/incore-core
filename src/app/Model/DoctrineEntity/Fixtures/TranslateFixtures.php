...
class TranslateFixtures extends \Doctrine\Bundle\FixturesBundle\Fixture implements \Doctrine\Common\DataFixtures\FixtureInterface, \Doctrine\Common\DataFixtures\DependentFixtureInterface
{
	private array $translates = [
		...
		'flash_receiverInvalidRemoved' => 'Tyto e-maily jsou neplatné a byly odebrány: %emails%',
		...
		'input_locked' => 'Uzamknout formulář',
		'column_locked' => 'Zámek',
		'flash_formLocked' => 'Formulář je uzamčen, nemáte oprávnění jej upravovat ani mazat.',
		...
		'header_editEmail' => 'Editace emailu',
		...
		'menu_translateEmail' => 'Přeložit texty',
		'flash_emailSendToTranslate' => 'Texty emailu byly odeslány k překladu',
		...
		'column_languageTranslateLog_datetime' => 'Datum',
		...
		'menu_languageTranslateLog_markFinishedByCallbacks' => 'Označit doručené jako dokončené',
		'flash_languageTranslateLog_marked' => 'Podle přijatých callbacků označeno %count% záznamů jako dokončené',
		...
		'flash_notEnoughCredits' => 'Na překlad nemáte dostatek kreditů. Dobijte si prosím kredit a spusťte překlad znovu.',
		'flash_notEnoughCreditsPartial' => 'Část textů byla odeslána k překladu, na zbytek už nezbyl kredit. Dobijte si prosím kredit a spusťte překlad znovu.',
		...
		'menu_translateTags' => 'Přeložit tagy',
		'flash_tagsSendToTranslate' => 'Nepřeložené tagy byly odeslány k překladu',
		'flash_tagsAllTranslated' => 'Všechny tagy jsou už přeložené, není co odeslat',
		...
		'input_formReceiverPlaceholder' => 'Přidat e-mail…',
		'input_discordErrorLogUrl' => 'Discord URL pro logování chyb',
		'input_sentryDsn' => 'Sentry DSN pro logování chyb',
