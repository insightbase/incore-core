...
class TranslateFixtures extends \Doctrine\Bundle\FixturesBundle\Fixture implements \Doctrine\Common\DataFixtures\FixtureInterface, \Doctrine\Common\DataFixtures\DependentFixtureInterface
{
	private array $translates = [
		...
		'header_staticPage' => 'Statické stránky',
		'header_staticPageEdit' => 'Editace',
		'header_staticPageNew' => 'Nová',
		'menu_staticPageNew' => 'Nová statická stránka',
		'group_staticPageGeneral' => 'Obecné',
		'input_staticPageActive' => 'Aktivní',
		'input_staticPageSystemName' => 'Systémový název',
		'group_staticPage_general' => 'Obecné',
		'input_staticPageName' => 'Název',
		'input_staticPageSlug' => 'Slug',
		'input_staticPageContent' => 'Obsah',
		'group_staticPage_seo' => 'SEo',
		'input_staticPageTitle' => 'Title',
		'input_staticPageDescription' => 'Description',
		'input_staticPageKeywords' => 'Keywords',
		'input_staticPageCreate' => 'Vytvořit',
		'input_staticPageUpdate' => 'Upravit',
		'staticPage_listTitle' => 'Statické stránky',
		'column_staticPage_name' => 'Název',
		'column_article_active' => 'Aktivní',
		'flash_staticPageDeleted' => 'Smazat',
		'flash_actionUpdated' => 'Statická stránka upravena',
		'flash_actionCreated' => 'Statická stránka vytvořena',
		'flash_staticPageNotFound' => 'Statická stránka nebyla  nalezena',
