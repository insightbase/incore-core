...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_content_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./content.css */ "./node_modules/css-loader/dist/cjs.js!./assets/admin/content.css");
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_editorJs_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./editorJs.css */ "./node_modules/css-loader/dist/cjs.js!./assets/admin/editorJs.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_editorJs_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_editorJs_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_editorJs_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_editorJs_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);


/***/ }),

/***/ "./assets/admin/editorJs.js":
/*!**********************************!*\
  !*** ./assets/admin/editorJs.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initEditorJs: () => (/* binding */ initEditorJs)
/* harmony export */ });
...
/* harmony import */ var _editorjs_raw__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @editorjs/raw */ "./node_modules/@editorjs/raw/dist/raw.mjs");
/* harmony import */ var _editorjs_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @editorjs/list */ "./node_modules/@editorjs/list/dist/editorjs-list.mjs");
/* harmony import */ var _editorjs_paragraph__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @editorjs/paragraph */ "./node_modules/@editorjs/paragraph/dist/paragraph.mjs");
...
/* harmony import */ var _editorjs_table__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @editorjs/table */ "./node_modules/@editorjs/table/dist/table.mjs");
/* harmony import */ var naja__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! naja */ "./node_modules/naja/dist/Naja.esm.js");
...
function initEditorJs() {
    Array.from(document.getElementsByClassName('editorJsText')).forEach((element) => {
        ...
        if (types.includes("raw")) {
            tools.raw = _editorjs_raw__WEBPACK_IMPORTED_MODULE_1__["default"];
        }
        if (types.includes("paragraph")) {
            tools.paragraph = {
                class: _editorjs_paragraph__WEBPACK_IMPORTED_MODULE_3__["default"],
                config: {
        ...
        if (types.includes("header")) {
            tools.header = {
                class: _editorjs_header__WEBPACK_IMPORTED_MODULE_4__["default"],
                inlineToolbar: true,
                config: {
        ...
        if (types.includes("table")) {
            tools.table = _editorjs_table__WEBPACK_IMPORTED_MODULE_5__["default"];
        }

        window.editors[id] = new _editorjs_editorjs__WEBPACK_IMPORTED_MODULE_0__["default"]({
            holder: editorDiv,
            data: data,
            tools: tools
        });
...
var Ce = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof __webpack_require__.g < "u" ? __webpack_require__.g : typeof self < "u" ? self : {};
function Ke(n) {
...
var A = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof __webpack_require__.g < "u" ? __webpack_require__.g : typeof self < "u" ? self : {};
function wt(e) {
  if (e.__esModule)
    return e;
  var t = e.default;
...
.modal .codex-editor__redactor{
    padding-bottom: 0 !important;
}
body.content .draggable .menu{
    display: none;
}
body.content .draggable:hover .menu{
    display: block;
}

#snippet-gridRecord-dataGrid {
    overflow: auto  !important;
}

.item.card.draggable .menu {
...
/* TODO: remove from templates, if OK */
form.max-w-2xl{
    max-width: 100% !important;
}

.blockItem-value-edit{
    display: none;
}
.item.card.draggable:hover .blockItem-value-edit{
    display: block;
}
.item.card.draggable:hover .blockItem-value-show{
    display: none;
}
...
.flex.justify-end.mt-6 .btn.btn-primary {
    margin-bottom: 3rem;
}
...
.tab-error-indicator {
    ...
    color: #fff;
    font-weight: bold;
}`, "",{"version":3,"sources":["webpack://./assets/admin/app.css"],"names":[],"mappings":"AAAA;EACE,wBAAwB;AAC1B;;AAEA;EACE,SAAS;AACX;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,2BAA2B;EAC3B,WAAW;AACb;;AAEA;EACE,SAAS;AACX;;AAEA;EACE
,6BAA6B;IAC7B,2BAA2B;IAC3B,4BAA4B;IAC5B,0BAA0B;IAC1B,aAAa;AACjB;AACA;IACI,iBAAiB;IACjB,WAAW;AACf;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,4BAA4B;IAC5B,2CAA2C;IAC3C,iCAAiC;IACjC,uCAAuC;IACvC,qCAAqC;IACrC,oBAAoB;AACxB;;AAEA;IACI,8BAA8B;AAClC;;AAEA;;IAEI,+BAA+B;AACnC;;;AAGA;IACI,iBAAiB;IACjB,gBAAgB;IAChB,UAAU;IACV,mDAAmD;IACnD,kBAAkB;AACtB;;AAEA;IACI,UAAU;IACV,mBAAmB;AACvB;;AAEA;IACI,+BAA+B;IAC/B,2BAA2B;IAC3B,eAAe;AACnB;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,+BAA+B;AACnC;;AAEA;IACI,oBAAoB;IACpB,uBAAuB;IACvB,mBAAmB;IACnB,oBAAoB;IACpB,iBAAiB;IACjB,WAAW;IACX,YAAY;IACZ,oBAAoB;IACpB,mBAAmB;IACnB,WAAW;IACX,iBAAiB;AACrB","sourcesContent":["html {\r\n  scrollbar-gutter: stable;\r\n}\r\n\r\n.no-border {\r\n  border: 0;\r\n}\r\n\r\n.ml-4 {\r\n  margin-left: 1rem;\r\n}\r\n\r\n.mr-3 {\r\n  padding-right: 0.75rem;\r\n}\r\n\r\n.space-y-4 > :not([hidden]) ~ :not([hidden]) {\r\n  margin-top: 1rem;\r\n}\r\n\r\n.switch input[type=\"checkbox\"]:checked {\r\n  background-image: unset !important;\r\n}\r\n\r\n.color-dark {\r\n  color: var(--tw-dark);\r\n}\r\n\r\n.max-w-32 {\r\n  max-width: 264px !important;\r\n  width: 100%;\r\n}\r\n\r\n.gap-8 {\r\n  gap: 2rem;\r\n}\r\n\r\n.mt-10 {\r\n  margin-top: 2.5rem !important;\r\n}\r\n\r\ndiv.imageContainer {\r\n    position: relative;\r\n    a.imageUpdate {\r\n        cursor: pointer;\r\n        position: absolute;\r\n        right: 0;\r\n        bottom: 0;\r\n    }\r\n}\r\n.dz-image a.imageUpdate{\r\n    background-color: white;\r\n    right: 10px;\r\n    bottom: 10px;\r\n    cursor: pointer;\r\n    position: absolute;\r\n}\r\n.editorJsText{\r\n    display: none !important;\r\n}\r\n\r\n.editorJsText{\r\n    font-family: sans-serif;\r\n    border: 1px solid black;\r\n}\r\n\r\n.dropzone {\r\n    height: auto !important;\r\n    min-height: 120px !important;\r\n    border: 2px dashed var(--tw-gray-300) !important;\r\n    border-radius: 8px !important;\r\n    background-color: #f9fafb !important;\r\n    transition: none !important;\r\n    display: flex !important;\r\n    align-items: center !important;\r\n    padding: 20px !important;\r\n}\r\n\r\n.dropzone .dz-button {\r\n    color: #000 !important;\r\n}\r\n\r\n.dropzone:hover {\r\n    border-color: var(--tw-primary) !important;\r\n    background-color: rgba(var(--tw-primary-rgb, 0, 120, 212), 0.05) !important;\r\n}\r\n\r\n\r\n.dropzoneContainer input {\r\n    display: none !important;\r\n}\r\n\r\n.dropzone:hover .dz-button {\r\n    color: var(--tw-primary) !important;\r\n}\r\n\r\n.dropzone .dz-message {\r\n    color: var(--tw-primary) !important;\r\n    font-weight: 500 !important;\r\n    text-align: center !important;\r\n    margin: 0 !important;\r\n    width: 100%;\r\n}\r\n\r\n.dropzone.dz-drag-hover {\r\n    border-color: var(--tw-primary) !important;\r\n    background-color: rgba(var(--tw-primary-rgb, 0, 120, 212), 0.1) !important;\r\n}\r\n\r\n\r\nhtml.dark .dropzone {\r\n    background-color: var(--tw-light-active) !important;\r\n    border: 2px dashed var(--tw-gray-300) !important;\r\n}\r\n\r\nhtml.dark .dz-button {\r\n    color: var(--tw-gray-700) !important;\r\n}\r\n\r\nhtml.dark .dropzone .dz-preview.dz-image-preview {\r\n    background-color: var(--tw-light-active) !important;\r\n    border: 1px solid var(--tw-gray-300) !important;\r\n}\r\n\r\n.dropzone {\r\n    max-width: 534px !important;\r\n    overflow-x: auto;\r\n    overflow-y: hidden;\r\n\r\n    scrollbar-width: thin; /* Firefox */\r\n    scrollbar-color: #888 #f1f1f1; /* Firefox */\r\n}\r\n\r\n/* (Chrome, Safari, etc.) */\r\n.dropzone::-webkit-scrollbar {\r\n    height: 6px;\r\n}\r\n\r\n.dropzone::-webkit-scrollbar-track {\r\n    background: #f1f1f1;\r\n    border-radius: 3px;\r\n}\r\n\r\n.dropzone::-webkit-scrollbar-thumb {\r\n    background: #888;\r\n    border-radius: 3px;\r\n}\r\n\r\n.dropzone::-webkit-scrollbar-thumb:hover {\r\n    background: #969696;\r\n}\r\n\r\n.dropzoneContainer input {\r\n    display: none !important;\r\n}\r\n\r\n.dropzone .dz-message {\r\n    color: var(--tw-primary);\r\n}\r\n\r\n#snippet-grid-dataGrid {\r\n    overflow-x: auto !important;\r\n}\r\n\r\n.dz-preview {\r\n    z-index: 0 !important;\r\n    padding: .5rem;\r\n    border-radius: 20px;\r\n}\r\n\r\n.form-control {\r\n    display: flex;\r\n    gap: .5rem;\r\n    flex-direction: column;\r\n}\r\n\r\n\r\n.form-control input[type=checkbox] {\r\n    appearance: none;\r\n    -webkit-appearance: none;\r\n    -moz-appearance: none;\r\n    background-color: #fff;\r\n    border: 1px solid #ccc;\r\n    cursor: pointer;\r\n    display: inline-block;\r\n    position: relative;\r\n    margin: 0;\r\n    padding: 0;\r\n    vertical-align: middle;\r\n    box-sizing: border-box;\r\n    transition: all 0.2s ease-in-out;\r\n    border-radius: .375rem;\r\n}\r\n\r\n.form-control .max-w-32 {\r\n    max-width: unset !important;\r\n}\r\n\r\n.formLanguageSelect {\r\n    display: inline-flex;\r\n    align-items: center;\r\n    cursor: pointer;\r\n    line-height: 1;\r\n    border-radius: .375rem;\r\n    padding-block: .25rem;\r\n    gap: .375rem;\r\n    border: 1px solid transparent;\r\n    font-weight: 500;\r\n    font-size: .9rem;\r\n    outline: none;\r\n    color: var(--tw-primary);\r\n    padding-inline: 1rem;\r\n}\r\n\r\n.formLanguageSelect option {\r\n    color: #000000;\r\n}\r\n\r\n.formLanguageSelect:focus {\r\n    box-shadow: 0 0 0 0.2rem rgba(var(--tw-primary-rgb, 0, 123, 255), 0.25);\r\n}\r\n\r\n.formLanguageSelect:disabled {\r\n    opacity: 0.65;\r\n    cursor: not-allowed;\r\n}\r\n\r\n.dropdown-content .menu-link {\r\n    font-size: .85rem !important;\r\n    padding-inline: .25rem !important;\r\n    padding-block: .2rem !important;\r\n}\r\n\r\ntextarea {\r\n    line-height: normal !important;\r\n}\r\n\r\n\r\n.fieldset {\r\n    padding-block: 1.5rem !important;\r\n}\r\n[hidden]{\r\n    display: none;\r\n}\r\n\r\n.modal .codex-editor__redactor{\r\n    padding-bottom: 0 !important;\r\n}\r\nbody.content .draggable .menu{\r\n    display: none;\r\n}\r\nbody.content .draggable:hover .menu{\r\n    display: block;\r\n}\r\n\r\n#snippet-gridRecord-dataGrid {\r\n    overflow: auto  !important;\r\n}\r\n\r\n.item.card.draggable .menu {\r\n    padding-inline-start: 1.875rem;\r\n    padding-inline-end: 1.875rem;\r\n    padding-top: 1.25rem;\r\n    padding-bottom: 1.25rem;\r\n}\r\n\r\ndiv.draggable-zone {\r\n    display: flex;\r\n    flex-direction: column;\r\n    gap: 1rem;\r\n}\r\n\r\n/* TODO: remove from templates, if OK */\r\nform.max-w-2xl{\r\n    max-width: 100% !important;\r\n}\r\n\r\n.blockItem-value-edit{\r\n    display: none;\r\n}\r\n.item.card.draggable:hover .blockItem-value-edit{\r\n    display: block;\r\n}\r\n.item.card.draggable:hover .blockItem-value-show{\r\n    display: none;\r\n}\r\n\r\n.page-bg {\r\n    background-size: cover !important;\r\n}\r\n\r\n.my-7 {\r\n    margin-top: 1.75rem !important;\r\n    margin-bottom: 1.75rem !important;\r\n}\r\n\r\n.px-7 {\r\n    padding-left: 1.75rem !important;\r\n    padding-right: 1.75rem !important;\r\n}\r\n\r\n.py-7 {\r\n    padding-top: 1.75rem !important;\r\n}\r\n\r\n.pt-7 {\r\n    padding-top: 1.75rem !important;\r\n}\r\n\r\n.pb-7 {\r\n    padding-bottom: 1.75rem !important;\r\n}\r\n\r\n\r\n.modal.open {\r\n    display: grid !important;\r\n    align-items: center !important;\r\n}\r\n\r\n.modal-footer {\r\n    padding-inline-start: 1.25rem;\r\n    padding-inline-end: 1.25rem;\r\n    padding-block-start: .625rem;\r\n    padding-block-end: .625rem;\r\n    outline: none;\r\n}\r\n.max-w-\\[1000px\\] {\r\n    max-width: 1000px;\r\n    width: 100%;\r\n}\r\n\r\n.flex.justify-end.mt-6 .btn.btn-primary {\r\n    margin-bottom: 3rem;\r\n}\r\n\r\n.codex-editor {\r\n    border: 1px solid !important;\r\n    border-color: var(--tw-gray-400) !important;\r\n    border-radius: .375rem !important;\r\n    padding-inline-start: .75rem !important;\r\n    padding-inline-end: .75rem !important;\r\n    padding-block: .5rem;\r\n}\r\n\r\n.codex-editor__redactor {\r\n    padding-bottom: 0px !important;\r\n}\r\n\r\n.ce-block__content,\r\n.ce-toolbar__content {\r\n    margin-inline: unset !important;\r\n}\r\n\r\n\r\n.accordion-content {\r\n    /*max-height: 0;*/\r\n    overflow: hidden;\r\n    opacity: 0;\r\n    transition: max-height 0.4s ease, opacity 0.4s ease;\r\n    visibility: hidden;\r\n}\r\n\r\n.accordion-content:not(.hidden) {\r\n    opacity: 1;\r\n    visibility: visible;\r\n}\r\n\r\n.accordion-toggle {\r\n    transition: transform 0.3s ease;\r\n    contain: layout style paint;\r\n    cursor: pointer;\r\n}\r\n\r\n.accordion-active i {\r\n    transform: rotate(180deg);\r\n}\r\n\r\n.accordion-toggle i {\r\n    transition: transform 0.3s ease;\r\n}\r\n\r\n.tab-error-indicator {\r\n    display: inline-flex;\r\n    justify-content: center;\r\n    align-items: center;\r\n    margin-left: 0.35rem;\r\n    font-size: 0.7rem;\r\n    width: 1rem;\r\n    height: 1rem;\r\n    border-radius: 999px;\r\n    background: #dc3545;\r\n    color: #fff;\r\n    font-weight: bold;\r\n}"],"sourceRoot":""}]);
// Exports
...
/***/ "./node_modules/css-loader/dist/cjs.js!./assets/admin/content.css":
/*!************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./assets/admin/content.css ***!
  \************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `body.contentdetail .card, body.contentdetail form#frm-formNewItem {
  background: #fff;
  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.03); }

body.contentdetail .container-fixed {
  max-width: 1200px;
  margin: 0 auto;
  padding: 0 1rem; }

body.contentdetail .grid {
  display: grid;
...
body.contentdetail .draggable:hover .menu {
  display: flex !important; }

body.contentdetail .draggable-zone {
  display: flex;
  flex-direction: column;
  gap: 1rem;
  min-height: 200px;
...
body.contentdetail .draggable-zone:focus-within {
  border-color: #e2e8f0; }

body.contentdetail .card {
...
body.contentdetail .card.draggable:hover {
  border-color: #e2e8f0;
  box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.06);
  transform: translateY(-1px); }

body.contentdetail .card:focus-within {
  border-color: #cbd5e1;
  box-shadow: 0 0 0 2px rgba(148, 163, 184, 0.1); }

body.contentdetail .card.dragging {
  opacity: .9;
...
body.contentdetail .card .card-body {
  padding: 1.25rem 4rem 1.25rem 1.25rem; }

body.contentdetail .card h2 {
  margin: 0 0 1rem;
  font-size: 1.125rem;
  font-weight: 600;
  color: #1e293b;
...
body.contentdetail .card h2::before {
  content: "";
  width: 3px;
  height: 1rem;
  border-radius: 2px;
...
body.contentdetail .card .office-detail-value .day, body.contentdetail .card ul li {
  align-items: center;
  padding: .5rem;
  font-size: .875rem; }

body.contentdetail .card .type-news h2::before {
  background: #3b82f6; }

body.contentdetail .card .type-office h2::before {
  background: #10b981; }

body.contentdetail .card .type-employer h2::before {
  background: #8b5cf6; }

body.contentdetail .card .type-contact h2::before {
  background: #f59e0b; }

body.contentdetail .card .type-footer h2::before {
  background: #64748b; }

body.contentdetail .card .type-download h2::before {
  background: #ef4444; }

body.contentdetail .card .blockItem-value-show {
  display: block;
  margin: .375rem 0;
  padding: .5rem;
  font-size: .875rem;
...
body.contentdetail .card .blockItem-value-edit {
  display: none;
  margin: .375rem 0;
  padding: .5rem;
  font-size: .875rem;
...
body.contentdetail .card .office-detail-value .blockItem-value-edit, body.contentdetail .card:hover .blockItem-value-show, body.contentdetail .card:hover .office-detail-value .blockItem-value-show {
  display: none; }

body.contentdetail .card .office-detail-value .blockItem-value-show, body.contentdetail .card:hover .blockItem-value-edit, body.contentdetail .card:hover .office-detail-value .blockItem-value-edit {
  display: block; }

body.contentdetail .card .blockItem-value-edit p, body.contentdetail .card .blockItem-value-show p {
  margin: .25rem 0;
  color: #475569;
  font-weight: 500; }

body.contentdetail .card .blockItem-value-edit span, body.contentdetail .card .blockItem-value-show span {
  color: #64748b;
  font-weight: 500; }

body.contentdetail .card .office-detail-value .day {
  gap: .5rem;
  background: #f8fafc;
  border-radius: 4px; }

body.contentdetail .card .office-detail-value .day span:first-child {
  min-width: 70px;
  font-weight: 600;
  color: #374151; }

body.contentdetail .card .office-detail-value .officeOpen {
  font-weight: 500;
  color: #059669; }

body.contentdetail .card .input:not(.checkbox) {
  margin: .25rem 0;
  font-size: .875rem;
...
body.contentdetail .card .input.inactive:not(.checkbox){
  border-color: white;
}

body.contentdetail .card .menu a, body.contentdetail .card ul li {
  display: flex;
  border-radius: 4px; }

body.contentdetail .card .input:not(.checkbox):focus {
  border-color: #94a3b8;
  box-shadow: 0 0 0 2px rgba(148, 163, 184, 0.1);
  outline: 0; }

body.contentdetail .card .input:not(.checkbox):hover, body.contentdetail .card .menu a:hover {
  border-color: #cbd5e1; }

body.contentdetail .card ul {
  margin: .5rem 0;
  padding: 0;
  list-style: none; }

body.contentdetail .card ul li {
  justify-content: space-between;
  margin: .25rem 0;
  background: #f8fafc; }

body.contentdetail .card ul li a {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 1.25rem;
...
body.contentdetail .card ul li a:hover {
  background: #e2e8f0; }

body.contentdetail .card ul li a i {
  font-size: .75rem; }
body.contentdetail .card ul li span{
    display: flex;
    align-items: center;
}

body.contentdetail .card .menu {
  position: absolute;
  top: 1rem;
  right: 1rem;
  display: flex;
...
body.contentdetail .card:focus-within .menu, body.contentdetail .card:hover .menu {
  opacity: 1; }

body.contentdetail .card .menu a {
  align-items: center;
  justify-content: center;
  width: 1.75rem;
  height: 1.75rem;
...
body.contentdetail .card .menu a:hover {
  background: #f8fafc;
  color: #475569;
  transform: translateY(-1px); }

body.contentdetail .card .menu a:first-child:hover {
  background: #eff6ff;
  border-color: #93c5fd;
  color: #2563eb; }

body.contentdetail .card .menu a:nth-child(2):hover {
  background: #fef2f2;
  border-color: #fca5a5;
  color: #dc2626; }

body.contentdetail .card .menu .draggable-handle {
  cursor: grab;
  background: #f8fafc;
  border-color: #cbd5e1; }

body.contentdetail .card .menu .draggable-handle:hover {
  background: #f1f5f9;
  border-color: #94a3b8;
  color: #475569;
  transform: translateY(-1px); }

body.contentdetail .card .menu .draggable-handle:active {
  cursor: grabbing;
  background: #e2e8f0;
  transform: translateY(0); }

body.contentdetail form#frm-formNewItem {
  border: 1px solid #f1f5f9;
  border-radius: 8px;
  padding: 1.25rem;
  position: sticky;
...
body.contentdetail form#frm-formNewItem .form-label {
  font-weight: 600;
  color: #374151;
  margin-bottom: .5rem; }

body.contentdetail form#frm-formNewItem .select {
  margin-bottom: 1rem; }

body.contentdetail form#frm-formNewItem .btn {
  margin-top: .75rem; }
...
body.contentdetail .card:focus, body.contentdetail .draggable-zone:focus {
  outline: 0; }

body.contentdetail .card.loading {
  opacity: .6;
  pointer-events: none; }

body.contentdetail .card.loading::after {
  content: "";
  position: absolute;
  top: 50%;
  left: 50%;
...
body.contentdetail .card.dragging .menu {
  opacity: 1; }

body.contentdetail .card.dragging .menu .draggable-handle {
  cursor: grabbing;
box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.03); }\r\n\r\nbody.contentdetail .container-fixed {\r\n  max-width: 1200px;\r\n  margin: 0 auto;\r\n  padding: 0 1rem; }\r\n\r\nbody.contentdetail .grid {\r\n  display: grid;\r\n  grid-template-columns: 1fr;\r\n  gap: 1.5rem; }\r\n\r\n@media (min-width: 1024px) {\r\n  body.contentdetail .grid {\r\n    grid-template-columns: 2fr 400px;\r\n    gap: 2rem;\r\n    align-items: start; } }\r\n\r\nbody.contentdetail .draggable:hover .menu {\r\n  display: flex !important; }\r\n\r\nbody.contentdetail .draggable-zone {\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 1rem;\r\n  min-height: 200px;\r\n  padding: 1rem;\r\n  border: 2px dashed #f1f5f9;\r\n  border-radius: 8px;\r\n  transition: border-color .2s; }\r\n\r\nbody.contentdetail .draggable-zone:focus-within {\r\n  border-color: #e2e8f0; }\r\n\r\nbody.contentdetail .card {\r\n  border: 1px solid #f1f5f9;\r\n  border-radius: 8px;\r\n  overflow: hidden;\r\n  position: relative;\r\n  cursor: default;\r\n  transition: none;\r\n  animation: .2s ease-out slideIn;\r\n  min-height: 100px;\r\n}\r\n\r\nbody.contentdetail .card.draggable:hover {\r\n  border-color: #e2e8f0;\r\n  box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.06);\r\n  transform: translateY(-1px); }\r\n\r\nbody.contentdetail .card:focus-within {\r\n  border-color: #cbd5e1;\r\n  box-shadow: 0 0 0 2px rgba(148, 163, 184, 0.1); }\r\n\r\nbody.contentdetail .card.dragging {\r\n  opacity: .9;\r\n  transform: rotate(1deg) scale(1.01) !important;\r\n  box-shadow: 0 8px 16px -4px rgba(0, 0, 0, 0.12) !important;\r\n  z-index: 1000;\r\n  border-color: #cbd5e1 !important;\r\n  transition: none !important;\r\n  user-select: none;\r\n  -webkit-user-select: none;\r\n  -moz-user-select: none;\r\n  -ms-user-select: none; }\r\n\r\nbody.contentdetail .card .card-body {\r\n  padding: 1.25rem 4rem 1.25rem 1.25rem; }\r\n\r\nbody.contentdetail .card h2 {\r\n  margin: 0 0 1rem;\r\n  font-size: 1.125rem;\r\n  font-weight: 600;\r\n  color: #1e293b;\r\n  display: flex;\r\n  align-items: center;\r\n  gap: .5rem; }\r\n\r\nbody.contentdetail .card h2::before {\r\n  content: \"\";\r\n  width: 3px;\r\n  height: 1rem;\r\n  border-radius: 2px;\r\n  flex-shrink: 0; }\r\n\r\nbody.contentdetail .card .office-detail-value .day, body.contentdetail .card ul li {\r\n  align-items: center;\r\n  padding: .5rem;\r\n  font-size: .875rem; }\r\n\r\nbody.contentdetail .card .type-news h2::before {\r\n  background: #3b82f6; }\r\n\r\nbody.contentdetail .card .type-office h2::before {\r\n  background: #10b981; }\r\n\r\nbody.contentdetail .card .type-employer h2::before {\r\n  background: #8b5cf6; }\r\n\r\nbody.contentdetail .card .type-contact h2::before {\r\n  background: #f59e0b; }\r\n\r\nbody.contentdetail .card .type-footer h2::before {\r\n  background: #64748b; }\r\n\r\nbody.contentdetail .card .type-download h2::before {\r\n  background: #ef4444; }\r\n\r\nbody.contentdetail .card .blockItem-value-show {\r\n  display: block;\r\n  margin: .375rem 0;\r\n  padding: .5rem;\r\n  font-size: .875rem;\r\n  line-height: 1.5; }\r\n\r\nbody.contentdetail .card .blockItem-value-edit {\r\n  display: none;\r\n  margin: .375rem 0;\r\n  padding: .5rem;\r\n  font-size: .875rem;\r\n  line-height: 1.5; }\r\n\r\nbody.contentdetail .card .office-detail-value .blockItem-value-edit, body.contentdetail .card:hover .blockItem-value-show, body.contentdetail .card:hover .office-detail-value .blockItem-value-show {\r\n  display: none; }\r\n\r\nbody.contentdetail .card .office-detail-value .blockItem-value-show, body.contentdetail .card:hover .blockItem-value-edit, body.contentdetail .card:hover .office-detail-value .blockItem-value-edit {\r\n  display: block; }\r\n\r\nbody.contentdetail .card .blockItem-value-edit p, body.contentdetail .card .blockItem-value-show p {\r\n  margin: .25rem 0;\r\n  color: #475569;\r\n  font-weight: 500; }\r\n\r\nbody.contentdetail .card .blockItem-value-edit span, body.contentdetail .card .blockItem-value-show span {\r\n  color: #64748b;\r\n  font-weight: 500; }\r\n\r\nbody.contentdetail .card .office-detail-value .day {\r\n  gap: .5rem;\r\n  background: #f8fafc;\r\n  border-radius: 4px; }\r\n\r\nbody.contentdetail .card .office-detail-value .day span:first-child {\r\n  min-width: 70px;\r\n  font-weight: 600;\r\n  color: #374151; }\r\n\r\nbody.contentdetail .card .office-detail-value .officeOpen {\r\n  font-weight: 500;\r\n  color: #059669; }\r\n\r\nbody.contentdetail .card .input:not(.checkbox) {\r\n  margin: .25rem 0;\r\n  font-size: .875rem;\r\n  padding: .375rem .75rem;\r\n  border-radius: 4px;\r\n  background: #fff;\r\n  border: 1px solid #e2e8f0;\r\n  transition: border-color .15s,box-shadow .15s; }\r\nbody.contentdetail .card .input.inactive:not(.checkbox){\r\n  border-color: white;\r\n}\r\n\r\nbody.contentdetail .card .menu a, body.contentdetail .card ul li {\r\n  display: flex;\r\n  border-radius: 4px; }\r\n\r\nbody.contentdetail .card .input:not(.checkbox):focus {\r\n  border-color: #94a3b8;\r\n  box-shadow: 0 0 0 2px rgba(148, 163, 184, 0.1);\r\n  outline: 0; }\r\n\r\nbody.contentdetail .card .input:not(.checkbox):hover, body.contentdetail .card .menu a:hover {\r\n  border-color: #cbd5e1; }\r\n\r\nbody.contentdetail .card ul {\r\n  margin: .5rem 0;\r\n  padding: 0;\r\n  list-style: none; }\r\n\r\nbody.contentdetail .card ul li {\r\n  justify-content: space-between;\r\n  margin: .25rem 0;\r\n  background: #f8fafc; }\r\n\r\nbody.contentdetail .card ul li a {\r\n  display: inline-flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  width: 1.25rem;\r\n  height: 1.25rem;\r\n  border-radius: 3px;\r\n  margin-left: .25rem;\r\n  transition: background-color .15s; }\r\n\r\nbody.contentdetail .card ul li a:hover {\r\n  background: #e2e8f0; }\r\n\r\nbody.contentdetail .card ul li a i {\r\n  font-size: .75rem; }\r\nbody.contentdetail .card ul li span{\r\n    display: flex;\r\n    align-items: center;\r\n}\r\n\r\nbody.contentdetail .card .menu {\r\n  position: absolute;\r\n  top: 1rem;\r\n  right: 1rem;\r\n  display: flex;\r\n  align-items: center;\r\n  gap: .375rem;\r\n  opacity: 0;\r\n  transition: opacity .15s; }\r\n\r\nbody.contentdetail .card:focus-within .menu, body.contentdetail .card:hover .menu {\r\n  opacity: 1; }\r\n\r\nbody.contentdetail .card .menu a {\r\n  align-items: center;\r\n  justify-content: center;\r\n  width: 1.75rem;\r\n  height: 1.75rem;\r\n  background: #fff;\r\n  border: 1px solid #e2e8f0;\r\n  color: #64748b;\r\n  transition: .15s;\r\n  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.04); }\r\n\r\nbody.contentdetail .card .menu a:hover {\r\n  background: #f8fafc;\r\n  color: #475569;\r\n  transform: translateY(-1px); }\r\n\r\nbody.contentdetail .card .menu a:first-child:hover {\r\n  background: #eff6ff;\r\n  border-color: #93c5fd;\r\n  color: #2563eb; }\r\n\r\nbody.contentdetail .card .menu a:nth-child(2):hover {\r\n  background: #fef2f2;\r\n  border-color: #fca5a5;\r\n  color: #dc2626; }\r\n\r\nbody.contentdetail .card .menu .draggable-handle {\r\n  cursor: grab;\r\n  background: #f8fafc;\r\n  border-color: #cbd5e1; }\r\n\r\nbody.contentdetail .card .menu .draggable-handle:hover {\r\n  background: #f1f5f9;\r\n  border-color: #94a3b8;\r\n  color: #475569;\r\n  transform: translateY(-1px); }\r\n\r\nbody.contentdetail .card .menu .draggable-handle:active {\r\n  cursor: grabbing;\r\n  background: #e2e8f0;\r\n  transform: translateY(0); }\r\n\r\nbody.contentdetail form#frm-formNewItem {\r\n  border: 1px solid #f1f5f9;\r\n  border-radius: 8px;\r\n  padding: 1.25rem;\r\n  position: sticky;\r\n  top: 5rem;\r\n  max-height: calc(100vh - 2rem);\r\n  overflow-y: auto; }\r\n\r\nbody.contentdetail form#frm-formNewItem .form-label {\r\n  font-weight: 600;\r\n  color: #374151;\r\n  margin-bottom: .5rem; }\r\n\r\nbody.contentdetail form#frm-formNewItem .select {\r\n  margin-bottom: 1rem; }\r\n\r\nbody.contentdetail form#frm-formNewItem .btn {\r\n  margin-top: .75rem; }\r\n\r\n@media (max-width: 768px) {\r\n  body.contentdetail .container-fixed {\r\n    padding: 0 .5rem; }\r\n  body.contentdetail .grid {\r\n    grid-template-columns: 1fr; }\r\n  body.contentdetail .card .card-body {\r\n    padding: 1rem 3rem 1rem 1rem; }\r\n  body.contentdetail .card .menu {\r\n    top: .75rem;\r\n    right: .75rem;\r\n    gap: .25rem; }\r\n  body.contentdetail .card .menu a {\r\n    width: 1.5rem;\r\n    height: 1.5rem; }\r\n  body.contentdetail .card h2 {\r\n    font-size: 1rem; }\r\n  body.contentdetail .card .office-detail-value .day {\r\n    flex-direction: column;\r\n    align-items: flex-start;\r\n    gap: .25rem; }\r\n  body.contentdetail form {\r\n    position: static;\r\n    max-height: none; } }\r\n\r\n@keyframes slideIn {\r\n  from {\r\n    opacity: 0;\r\n    transform: translateY(10px); }\r\n  to {\r\n    opacity: 1;\r\n    transform: translateY(0); } }\r\n\r\nbody.contentdetail .card:focus, body.contentdetail .draggable-zone:focus {\r\n  outline: 0; }\r\n\r\nbody.contentdetail .card.loading {\r\n  opacity: .6;\r\n  pointer-events: none; }\r\n\r\nbody.contentdetail .card.loading::after {\r\n  content: \"\";\r\n  position: absolute;\r\n  top: 50%;\r\n  left: 50%;\r\n  width: 16px;\r\n  height: 16px;\r\n  margin: -8px 0 0 -8px;\r\n  border: 2px solid #e2e8f0;\r\n  border-top-color: #64748b;\r\n  border-radius: 50%;\r\n  animation: 1s linear infinite spin; }\r\n\r\n@keyframes spin {\r\n  to {\r\n    transform: rotate(360deg); } }\r\n\r\nbody.contentdetail .card.dragging .menu {\r\n  opacity: 1; }\r\n\r\nbody.contentdetail .card.dragging .menu .draggable-handle {\r\n  cursor: grabbing;\r\n  background: #e2e8f0; }\r\nbody.contentdetail .blockItem-value-show .imageContainer, body.contentdetail .blockItem-value-edit .imageContainer{\r\n    display: inline-block;\r\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./node_modules/css-loader/dist/cjs.js!./assets/admin/editorJs.css":
/*!*************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./assets/admin/editorJs.css ***!
  \*************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.ce-header{
    font-weight: bold;
    font-size: 18px;
}
.ce-toolbar__actions{
    right: 100% !important;
}`, "",{"version":3,"sources":["webpack://./assets/admin/editorJs.css"],"names":[],"mappings":"AAAA;IACI,iBAAiB;IACjB,eAAe;AACnB;AACA;IACI,sBAAsB;AAC1B","sourcesContent":[".ce-header{\r\n    font-weight: bold;\r\n    font-size: 18px;\r\n}\r\n.ce-toolbar__actions{\r\n    right: 100% !important;\r\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form */ "./assets/admin/form.js");
/* harmony import */ var _app_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app.css */ "./assets/admin/app.css");
/* harmony import */ var _content_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./content.css */ "./assets/admin/content.css");
/* harmony import */ var nette_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! nette-forms */ "./node_modules/nette-forms/src/assets/netteForms.js");
/* harmony import */ var nette_forms__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(nette_forms__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _content_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./content.js */ "./assets/admin/content.js");
/* harmony import */ var _editorJs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./editorJs */ "./assets/admin/editorJs.js");
/* harmony import */ var _performance__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./performance */ "./assets/admin/performance.js");
/* harmony import */ var _performance__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_performance__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./tabs */ "./assets/admin/tabs.js");
...
/* harmony import */ var _editorJs_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./editorJs.css */ "./assets/admin/editorJs.css");
...
nette_forms__WEBPACK_IMPORTED_MODULE_6___default().initOnLoad();

let loaderId = null;
window.editors = {};

// Přepíšeme globální callback pro zobrazování chyb
(nette_forms__WEBPACK_IMPORTED_MODULE_6___default().showFormErrors) = function (form, errors) {
...
naja__WEBPACK_IMPORTED_MODULE_0__["default"].addEventListener('complete', (event) => {
    loader.hide(loaderId);
});
...
function initSystem(){
    ...
    initSortable();
    initDatagrid();
    (0,_editorJs__WEBPACK_IMPORTED_MODULE_8__.initEditorJs)();
    initDropzone();
    initFlashes();
    initMenu();
}
        ...
        element.addEventListener('keyup', function (event) {
            if (event.key === 'Enter') {
                ...
                globalSearchTimeout = setTimeout(function () {
                    let url = element.getAttribute('data-url').replace('xxxxxx', element.value);
                    naja__WEBPACK_IMPORTED_MODULE_0__["default"].makeRequest('GET', url).then((payload) => {
...
function initDropzone() {
        ...
        if (!element.dropzone) {
            ...
            dropzone.on('success', (file, response) => {
                if (element.getAttribute('data-multiple') == null) {
                    ...
                    naja__WEBPACK_IMPORTED_MODULE_0__["default"].uiHandler.bindUI(a);
    ...
    Array.from(document.getElementsByClassName('avatarContainer')).forEach((element, index) => {
        ...
        inputChanged.addEventListener('change', function(event){
            ...
            naja__WEBPACK_IMPORTED_MODULE_0__["default"].makeRequest('POST', url, formData, {history: false}).then(function(payload){
